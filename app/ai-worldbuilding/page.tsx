    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-background-tertiary">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-center">
          <span className="text-lg font-medium text-foreground">Yvonne Fang</span>
        </div>
      </nav>
      ...
      <div className="border-t border-background-tertiary">
        ...
        <section className="py-8 bg-background-secondary">
          <div className="max-w-4xl mx-auto px-6">
            <div className="w-full aspect-[16/9] relative overflow-hidden rounded-lg bg-black mb-3">
              <Image
        ...
        <section className="py-8">
          <div className="max-w-4xl mx-auto px-6">
            <div className="w-full aspect-[4/3] relative overflow-hidden rounded-lg bg-black mb-3">
              <Image
